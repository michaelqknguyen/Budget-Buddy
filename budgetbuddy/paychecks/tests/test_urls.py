...
class TestPaycheckUrl:
    def test_paychecks(self):
        ...
        assert resolve("/paychecks/").view_name == "paychecks:paychecks"
    ...
    def test_single_paycheck(self):
        ...
        assert (
            resolve(f"/paychecks/{proto_paycheck.id}").view_name == "paychecks:paycheck"
        )

    def test_add_paycheck(self):
        assert reverse("paychecks:paycheck_create") == "/paychecks/add"
        assert resolve("/paychecks/add").view_name == "paychecks:paycheck_create"
    ...
    def test_edit_paycheck(self):
        ...
        assert (
            resolve(f"/paychecks/{proto_paycheck.id}/edit").view_name
            == "paychecks:paycheck_edit"
        )
...
class TestPaystubUrl:
    def test_add_paystub(self):
        ...
        assert (
            resolve(f"/paychecks/paystub/{proto_paycheck.id}/add").view_name
    ...
    def test_delete_paystub(self):
        ...
        assert (
            resolve(f"/paychecks/paystub/{proto_paystub.id}/delete").view_name
...
class TestDeductionUrl:
    def test_add_deduction(self):
        assert reverse("paychecks:deduction_add") == "/paychecks/deduction/add"
        assert (
            resolve("/paychecks/deduction/add").view_name == "paychecks:deduction_add"
        )
    ...
    def test_edit_deduction(self):
        ...
        assert (
            resolve(f"/paychecks/deduction/{proto_deduction.id}/edit").view_name
            == "paychecks:deduction_edit"
        )
    ...
    def test_delete_deduction(self):
        ...
        assert (
            resolve(f"/paychecks/deduction/{proto_deduction.id}/delete").view_name
