...
urlpatterns = [
    ...
    path(
        "trans/<int:pk>/editm",
        views.StockTransactionUpdateView.as_view(money_or_budget="m"),
        name="transaction_edit_m",
    ),
    path(
        "trans/<int:pk>/editb",
        views.StockTransactionUpdateView.as_view(money_or_budget="b"),
    ...
    path(
        ...
        views.StockTransactionDeleteView.as_view(money_or_budget="m"),
        name="transaction_delete_m",
    ),
    path(
        "trans/<int:pk>/deleteb",
        views.StockTransactionDeleteView.as_view(money_or_budget="b"),
